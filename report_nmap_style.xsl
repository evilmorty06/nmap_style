  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <title>Reporte Nmap <xsl:value-of select="/nmaprun/@version"/></title>
      </head>
      <body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                <li><a href="#scannedhosts">Hosts escaneados</a></li>
                <li><a href="#onlinehosts">Hosts activos</a></li>
                <li><a href="#openservices">Puertos abiertos</a></li>
              </ul>
            </div>
          </div>
        </nav>
        <div class="container">
          <div class="jumbotron">
            <h1>Reporte Nmap <br/><small>Nmap <xsl:value-of select="/nmaprun/@version"/></small></h1>
          ...
          <h2 id="scannedhosts" class="target">Hosts escaneados<xsl:if test="/nmaprun/runstats/hosts/@down > 1024"><small> (offline hosts are hidden)</small></xsl:if></h2>
          ...
          <h2 id="onlinehosts" class="target">Hosts activos</h2>
          <xsl:for-each select="/nmaprun/host[status/@state='up']">
          ...
          <h2 id="openservices" class="target">Puertos abiertos</h2>
          <div class="table-responsive">
